...
exports.onDeleteTodoById =
  exports.onUpdateTodoById =
  exports.onGetTodoById =
  exports.onCreateNewTodo =
  exports.onGetAllTodos =
    void 0;
const database_1 = __importDefault(require("../database/database"));

const onGetAllTodos = (req, res) =>
...
const onCreateNewTodo = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.body.desc)
      return res.status(400).json("user description is required!");
    const { desc } = req.body;
    try {
      const newTodo = yield database_1.default.query(
...
const onGetTodoById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.params.id) return res.status(400).json("user ID is required!");
    const { id } = req.params;
    try {
      const oneToDo = yield database_1.default.query(
        "SELECT * FROM todos WHERE _id = $1",
        [id]
      );
...
const onUpdateTodoById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.params.id) return res.status(400).json("User ID is required!");
    const { id } = req.params;
    const { desc } = req.body;
    try {
      yield database_1.default.query(
        "UPDATE User SET description = $1 WHERE _id = $2",
        [desc, id]
      );
...
const onDeleteTodoById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
